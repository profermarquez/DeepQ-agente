...
(function(global) {
  ...
  Brain.prototype = {
    ...
    visSelf: function(elt) {
      ...
      var t = '';
      t += 'tamaño de repetición de la experiencia: ' + this.experience.length + '<br>';
      t += 'exploración épsilon: ' + this.epsilon + '<br>';
      t += 'edad: ' + this.age + '<br>';
      t += 'pérdida promedio de Q-learning: ' + this.average_loss_window.get_average() + '<br />';
      t += 'recompensa suave: ' + this.average_reward_window.get_average() + '<br />';
      desc.innerHTML = t;
